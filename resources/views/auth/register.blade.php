<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Referral Code -->
        <div class="mt-4">
            <x-input-label for="referral_code_input" :value="__('Referral Code (Optional)')" />
            <x-text-input id="referral_code_input" class="block mt-1 w-full" type="text" name="referral_code_input" :value="old('referral_code_input', $ref ?? '')" autocomplete="off" />
